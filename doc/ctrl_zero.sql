...
-- ----------------------------
BEGIN;
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (1, 0, 1, 0, 'dashboard', '/dashboard', 'basic', '仪表盘', 'mdi:monitor-dashboard', NULL, NULL, 'routes.dashboard._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:52', NULL, NULL, NULL, NULL);
...
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (4, 0, 2, 0, 'document', '/document', 'basic', '文档', 'mdi:file-document-multiple-outline', NULL, NULL, 'routes.document._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:53', NULL, NULL, NULL, NULL);
...
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (14, 0, 4, 0, 'plugin', '/plugin', 'basic', '插件示例', 'clarity:plugin-line', NULL, NULL, 'routes.plugin._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:53', NULL, NULL, NULL, NULL);
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (15, 14, NULL, 0, 'plugin_charts', '/plugin/charts', 'multi', '图表', 'mdi:chart-areaspline', NULL, NULL, 'routes.plugin.charts._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:53', NULL, NULL, NULL, NULL);
...
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (38, 0, 8, 0, 'multi-menu', '/multi-menu', 'basic', '多级菜单', 'carbon:menu', NULL, NULL, 'routes.multi-menu._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:53', NULL, NULL, NULL, NULL);
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (39, 38, NULL, 0, 'multi-menu_first', '/multi-menu/first', 'multi', '一级菜单', 'mdi:menu', NULL, NULL, 'routes.multi-menu.first._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:53', NULL, NULL, NULL, NULL);
...
INSERT INTO `menu` (`id`, `parent_id`, `order_no`, `is_leaf`, `name`, `path`, `component`, `title`, `icon`, `requires_auth`, `keep_alive`, `i18n_title`, `local_icon`, `href`, `single_layout`, `creator`, `created`, `creator_name`, `modifier`, `modified`, `modifier_name`) VALUES (43, 0, 9, 0, 'management', '/management', 'basic', '系统管理', 'carbon:cloud-service-management', NULL, NULL, 'routes.management._value', NULL, NULL, NULL, 1, '2023-08-27 21:07:53', NULL, NULL, NULL, NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (1, 'Soybean', '$2a$10$M.E1.0QiRv1Hv8rIlNEun.f95VtG47gpc1SJ3AkdEtgfEQT6GVR36', NULL, '1', 0, 1, '13333333333', 'admin@qq.com', 1, '2023-08-25 17:43:39', NULL, NULL, NULL, NULL);
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (3, 'admin', '$2a$10$IAiIxzSSL/9D41AlqoXfjOkLdNw.GaHSCzzeSMLqiV1pYAjQhGD1S', NULL, '1', 1, 0, '13333333333', 'admin@a.com', 1, '2023-08-26 11:27:35', NULL, NULL, NULL, NULL);
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (4, 'test', '$2a$10$woNG37gl/0PsMFBAhj/7U.xdgqn.X69.aM4c0NvYN2fqL20vpR35e', NULL, '2', 1, 1, '15555555555', 'test@test.com', 1, '2023-08-26 11:28:21', 1, '2023-08-26 13:44:51', '', '');
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (5, 'admin', '$2a$10$O6bigzv/PqUkVJlUH03N2Ok4smOXDeMUxQbVVvJyNNOw5zOKr2KPe', NULL, '1', 1, 0, '13333333333', 'admin@a.com', 1, '2023-08-26 11:29:53', 1, '2023-08-26 13:38:55', '', '');
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (6, '哈哈', '$2a$10$2NVjQu3bmo4bAD9MWH7hN.chbfuy75F1Hmu5eStYiQ4YN6.9pBoBa', NULL, '1', 4, 1, '13222222222', 'hh@t.com', 1, '2023-08-26 11:32:34', NULL, NULL, NULL, NULL);
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (8, 'kevin', '$2a$10$GmRIVTmucalnfkTyGzOTjuX5M21H/P.0W3Sjk/W8chRpHRiIUeOAa', NULL, '1', 0, 0, '13553535355', '', 1, '2023-08-26 11:37:30', NULL, NULL, NULL, NULL);
INSERT INTO `user` (`id`, `username`, `password`, `authority`, `status`, `age`, `gender`, `phone`, `email`, `creator`, `created`, `modifier`, `modified`, `creator_name`, `modifier_name`) VALUES (9, '牛牛', '$2a$10$68bIap18vdnoZnTo/sUKXOlG92wvLor.2ZtYu8N/s/N642PME6rtG', NULL, '1', 2, 0, '13244444444', '', 1, '2023-08-26 11:46:20', NULL, NULL, NULL, NULL);
COMMIT;
